...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    numerator = exp_scores[range(N), y]
    data_loss = np.mean(-1 * np.log(numerator/denominator))
